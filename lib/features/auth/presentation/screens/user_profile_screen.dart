...
class _ProfileNotifier extends StateNotifier<_ProfileState> {
  ...
  Future<void> _load() async {
    try {
      ...
      if (e.response?.statusCode == 404) {
        ...
        state = state.copyWith(
            isLoading: false, profileExists: false, clearError: true);
      } else {
  ...
  Future<bool> changePassword({
    ...
    state = state.copyWith(
        isChangingPassword: true, clearError: true, clearSuccess: true);
    try {
      ...
      state = state.copyWith(
          isChangingPassword: false, error: ErrorHandler.handle(e).message);
      return false;
    }
  }
...
final _profileProvider =
    StateNotifierProvider.autoDispose<_ProfileNotifier, _ProfileState>(
...
class _UserProfileScreenState extends ConsumerState<UserProfileScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final resolvedAvatar =
        resolveMediaUrl(_avatar.text.isNotEmpty ? _avatar.text : s.avatarUrl);
          ...
          : Column(children: [
              ...
              Container(
                ...
                child: Column(children: [
                  ...
                  Text(
                    auth.isAdminGlobal ? 'Admin Global' : 'Empresa asignada',
                    style: TextStyle(
                      fontSize: 12,
              ...
              if (!s.profileExists && s.error == null)
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(10)),
                  child: const Text(
                      'Tu perfil aún no fue creado. Completá tus datos y guardá para configurarlo.',
                  ...
                  children: [
                    ...
                    ListView(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 24),
                        AppButton(
                          label: s.isChangingPassword
                              ? 'Cambiando…'
                              : 'Cambiar contraseña',
                          onPressed: s.isChangingPassword
                              ? null
                              : () async {
                                  if (_currentPwd.text.isEmpty ||
                                      _newPwd.text.isEmpty ||
                                      _confirmPwd.text.isEmpty) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                        const SnackBar(
                                            content: Text(
